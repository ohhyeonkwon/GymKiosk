...
- **주량 조절:** 상품 이미지를 클릭하거나 주문내역에서 상품명 옆의 +, -버튼을 누르면 수량 조절 가능<br/>
- **전체삭제:** 결제하기 옆의 버튼을 클릭하면 주문내역 내의 상품이 모두 삭제<br/>
...
<table>
  ...
  <tr>
    <td>원인</td>
    <td>과거 php와 MySQL 사용하여 DB를 연동하려했으나 php의 숙련도가 낮아 어려움이 있었음</td>
  </tr>
  <tr>
    <td>해결</td>
    <td>node.js를 사용하는 프로젝트를 진행하며 얻은 지식과 숙련도를 토대로 node.js와 Mysql을 사용해서 서버를 구축하고 DB를 연동할 계획</td>
  </tr>
</table><br/><br/>
